...
Сучасний застосунок для керування списком завдань, створений на Vite + React 18 із використанням Custom Hooks, Component Composition та CSS Modules.
Додаток реалізує повний цикл роботи з задачами — створення, редагування, пошук, пагінацію та видалення — із чистою архітектурою та продуманими шаблонами проєктування.
Інтерфейс мінімалістичний, інтуїтивний і адаптований для комфортного користування.

---
🚀 Стек технологій

⚡ Vite – швидкий сучасний збірник фронтенду

⚛️ React 18 – бібліотека для створення інтерфейсів

🧩 React Hooks – управління станом і логікою без класів

🪝 Custom Hook (useTodos) – централізована логіка CRUD, пошуку та пагінації

🎨 CSS Modules – ізольована стилізація компонентів

🌐 DummyJSON API – інтеграція для роботи з реальними даними (fetch, delete, toggle)
